...
class storageDids {
    ...
    async storeObject(ctx, did, idStr, stateId, obj, type, role) {
        try {
    ...
    async storeObjectJson(ctx, did, idStr, stateId, obj) {
        await this.storeObject(ctx, did, idStr, stateId, JSON.stringify(obj), 'string', 'json');
    }
    async storeObjectTree(ctx, did, idStr, stateId, obj) {
        if (typeof(obj) == 'object') {
            ...
            await this.storeObject(ctx, did, idStr, stateId, obj, type, 'state');
        }
    }
