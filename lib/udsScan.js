 ...
 *
 * | State                                      | anyScanMissing | collectInfoMissing | scan-warning | rescan-hint |
 * |--------------------------------------------|----------------|--------------------|--------------|-------------|
 * | No scan done                               | true           | true               | shown        | —           |
 * | Old scan (pre-v1.x), no collect data       | false          | true               | —            | shown       |
 * | Old scan, collect known via migration      | false          | false              | —            | —           |
 * | New v1.x scan                              | false          | false              | —            | —           |
 *
 * anyScanMissing:    any device has didsScanDone=false (storage.js: Object.keys(didsWritable).length === 0)
 * collectInfoMissing: detectedCollectCanIds returned by getTabDids is empty
 */
